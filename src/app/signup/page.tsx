...
const Page = () => {
  ...
  }, [loginData, errors, showPassword, isLoading, handleLoginChange, handleLogin, resetForms]);
  ...
  }, [signupData, errors, showPassword, showConfirmPassword, isLoading, handleSignupChange, handleSignup, resetForms]);

  // Forgot Password Page Component
  const ForgotPasswordPage = useCallback(() => {
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
  ...
  }, [forgotEmail, errors, isLoading, handleForgotPassword, resetForms]);
        ...
        <div className="max-w-md w-full text-center">
          <div className="bg-gray-800/30 border border-gray-700/50 rounded-lg p-8 backdrop-blur-sm">
            ...
            <div className="space-y-3">
              {successType === 'login' && (
                <button className="w-full bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white py-3 rounded-lg font-medium transition-all duration-200 transform hover:scale-105">
                  Go to Dashboard
                </button>
              )}
  ...
  }, [successMessage, successType, resetForms]);
  ...
  }, [currentPage, LoginPage, SignupPage, ForgotPasswordPage, SuccessPage]);
